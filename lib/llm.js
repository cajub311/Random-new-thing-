...
export async function callOpenAI(provider, messages, model, apiKey, { tools } = {}) {
  ...
  // Some OpenAI-compatible backends (notably Pollinations' gpt-oss-20b) put
  // their chain-of-thought in reasoning_content and may leave content empty.
  // We DO NOT want to surface the scratchpad as the user-facing reply.
  // Instead, flag the response so the brain can nudge the model again.
