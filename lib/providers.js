...
export const PROVIDERS = {
  // ── LOCAL (opt-in via UI — never in DEFAULT_ORDER; no auto-fallback) ───
  ollama: {
    name: 'Ollama (local)',
    ...
    format: 'openai',
    supportsTools: true,
    description: 'Runs on your machine — enable below, then pick when reachable.',
  },
  lmstudio: {
    ...
    format: 'openai',
    supportsTools: true,
    description: 'Local OpenAI-compatible server — opt-in only.',
  },
  llamacpp: {
    ...
    format: 'openai',
    supportsTools: true,
    description: 'llama.cpp `server` binary — opt-in only.',
  },
